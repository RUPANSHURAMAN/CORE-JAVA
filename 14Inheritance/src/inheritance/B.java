...
// class object so that we can reuse the members of parent class 
// or moving the members of parent to child memory 
...
public class B extends A {
	public static void main(String[] args) {
		...
		System.out.println(a1.j); // REPLACED BY ole.j ACTUALLY NOT INHERITED BUT COMPILER CONVERTS a1.j to ole.j
