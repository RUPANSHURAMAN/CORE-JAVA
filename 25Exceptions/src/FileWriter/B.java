...
/* FOS vs. FW?
 * FOS requires the content to be converted into number using getBytes() whereas FileWriter can write directly string contents 
 */

/*
 *  File class used with FileReader and FilWriter and FOS, FIS but it cannot be used with BufferedReader and BufferedWriter
