...
/* 
 * *CLASS CAST: 
 * 1. Upcasting: Here child object memory addr is stored in parent class ref var 
 ...
 * 
 * 2. Downcasting: Instead of making the child object ref to be stored in parent class by mandat using downcasting operator(not CTE but RTE)
...
public class B extends A {
	...
	public static void main(String[] args) {
		...
		// System.out.println(a1.j); //child class member are not accesseinble with
											// using upcasting as made A class
	}
}
