...
public interface A {
	...
	// * we cannot create static method in an interface as they cannot be inherited and 
	// if they are not inherited then we cannot override it
	...
	// public static final int k; //ERROR as above
